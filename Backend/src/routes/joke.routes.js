...
// controllers import 
import { createJoke,deleteJokeById,getPublicJokes,getRandomJoke,myJokes, updateJokeById} from "../controllers/joke.controllers.js";
// routes  define
jokeRouter.get("/public",getPublicJokes);
